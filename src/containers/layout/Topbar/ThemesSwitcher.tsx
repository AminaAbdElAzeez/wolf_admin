...
const ThemesSwitcher: React.FC = () => {
          ...
          <Button
            className={`${
              el.themeId === themeName
                ? "text-[#ed1c24] hover:!text-main-red dark:text-variant dark:hover:!text-main-red"
                : ""
  ...
  return (
    ...
    >
      <div
        className={`cursor-pointer focus-visible:!outline-none  px-1 py-1 flex items-center box-content text-[#ed1c24] dark:text-[#fff] `}
      >
